...
<template>
  <div class="mx-auto">
    <div class="header text-center mx-auto">
      <span
          class="bg-[#25292E] border border-[#434957] px-4 py-2 text-sm rounded-md"
      >
        Developer-First Platform as a Service
      </span>
      <div class="mt-8">
        <h1 class="text-[#F7E9FF]">
          Deploy your Vue.js Site <span class="text-gradient block"
        >with <a
            class="hover:text-[#F7E9FF]"
            target="_blank"
            href="https://zerops.io">Zerops</a
        ></span
        >
        </h1>
